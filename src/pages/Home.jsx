...
const Home = () => {
  return (
    <>
    <Header/>
    <div className='relative overflow-hidden flex px-8 gap-7 h-180 bg-[#f0f0fa] items-center pb-20'> 
      <div>
      ...
      <div className='flex gap-6 mt-11'>
        <button className='p-2 w-70 text-[20px] bg-[#4f46e5] shadow-md text-white hover:cursor-pointer rounded-[10px] font-semibold'>Browse Books</button>
        <button className='p-2 w-70 text-[20px] bg-white shadow-md hover:cursor-pointer rounded-[10px] font-semibold'>Explore Categories</button>
        
      </div>
    </div>
    <div className='w-[70%] shadow-lg rounded-[20px]'>
